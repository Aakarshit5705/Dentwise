...
export async function createDoctors(input:CreateDoctorInput){
    try {
...
export async function updateDoctors(input:UpdateDoctorInput){
    try{
        if(!input.name||!input.email)throw new Error("Name and email are required!!");
...
export async function getAvailableDoctors() {
    try {
        ...
        console.log("Error in fetching av. doctors: ",error);
    }
}