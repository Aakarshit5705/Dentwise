...
function DentistSelectionStep({selectedDentistId,onContinue,onSelectDentist}:DentistSelectionStepProps) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold ">Choose Your Dentists</h2>
...
export default DentistSelectionStep
