        ...
        <CardContent className="relative p-8">
          ...
          <Link
            ...
            className={buttonVariants({
              variant: "default",
              className:
                "w-full mt-6 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-amber-600",
            })}
          >
