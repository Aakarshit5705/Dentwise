...
function DoctorManagement() {
    ...
    const[isEditialogOpen,setIsEditDialogOpen]=useState(false);
                ...
                {doctors.map((doctor)=>(
                    <div key={doctor.id} className="flex items-center justify-between p-4 bg-muted/30 rounded-xl border border-border/50">
                        <div className="flex items-center gap-4">
                            <Image src={doctor.imageUrl}
                            alt="Doctor pfp" width={48} height={48}
                            ...
                            <div className="lex items-center gap-4 mt-1">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="h-8 px-3"
                    onClick={() => handleEditDialog(doctor)}
                  >
    ...
    <EditDoctorDialog isOpen={isEditialogOpen} onClose={handleCloseEditDialog} doctor={selectDoctor} key={selectDoctor?.id}/>
