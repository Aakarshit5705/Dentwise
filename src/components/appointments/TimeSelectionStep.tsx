...
import { ChevronLeftIcon, Clock9Icon } from "lucide-react";
...
function TimeSelectionStep({selectedDentistId,selectedDate,selectedTime,selectedType,onDateChange,onBack,onContinue,onTimeChange,onTypeChange}:TimeSelectionStepProps) {
              ...
              <div className="grid grid-cols-3 gap-2">
                {availableTimeSlots.map((time) => {
                  ...
                  return (
                    ...
                    >
                      <Clock9Icon className="w-3 h-3 mr-1" />
                      {time}
                      {isBooked && " (Booked)"}
                    </Button>
                  );
